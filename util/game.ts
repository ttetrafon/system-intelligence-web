import type { MkDocument, DataLink, DataLinks, GameSystemData } from "@app-types/game";

function isMkDocument(value: unknown): value is MkDocument {
...
//     if (key === 'document' && isMkDocument(value)) {
//       // Document link
