...
export function buildReactNode(contents: string): ReactNode {
  ...
  if (contents.startsWith("######")) {
    contents = contents.slice(6).trim();
    return (<h6>{parseContents(contents)}</h6>);
  }
  if (contents.startsWith("#####")) {
    contents = contents.slice(5).trim();
    return (<h5>{parseContents(contents)}</h5>);
  }
  if (contents.startsWith("####")) {
    contents = contents.slice(4).trim();
    return (<h4>{parseContents(contents)}</h4>);
  }
  if (contents.startsWith("###")) {
    contents = contents.slice(3).trim();
    return (<h3>{parseContents(contents)}</h3>);
  }
  if (contents.startsWith("##")) {
    contents = contents.slice(2).trim();
    return (<h2>{parseContents(contents)}</h2>);
  }
  if (contents.startsWith("#")) {
...
export function parseContents(contents: string): ReactNode {
